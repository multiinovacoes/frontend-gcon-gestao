...
@Component({
  selector: 'app-lista-encaminhamentos-lai-enviados',
  templateUrl: './lista-encaminhamentos-lai-enviados.component.html',
  styleUrls: ['./lista-encaminhamentos-lai-enviados.component.css']
})
export class ListaEncaminhamentosLaiEnviadosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.title.setTitle('Lista de Pedidos Enviados');
  ...
  listar(pagina = 0) {
    ...
    this.atendimentoLaiService.listaAtendimentosLaiEnviados(this.filtro)
      .then(resultado =>{
