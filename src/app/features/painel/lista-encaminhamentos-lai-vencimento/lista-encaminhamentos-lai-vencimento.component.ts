...
@Component({
  selector: 'app-lista-encaminhamentos-lai-vencimento',
  templateUrl: './lista-encaminhamentos-lai-vencimento.component.html',
  styleUrls: ['./lista-encaminhamentos-lai-vencimento.component.css']
})
export class ListaEncaminhamentosLaiVencimentoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.title.setTitle('Lista de Pedidos Enviados Próximo ao Vencimento');
  ...
  listar(pagina = 0) {
    ...
    this.atendimentoLaiService.listaAtendimentosLaiEnviadosVencimento(this.filtro)
      .then(resultado =>{
