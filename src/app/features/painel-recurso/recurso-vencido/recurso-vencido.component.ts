...
@Component({
  selector: 'app-recurso-vencido',
  templateUrl: './recurso-vencido.component.html',
  styleUrls: ['./recurso-vencido.component.css']
})
export class RecursoVencidoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.title.setTitle('Lista de Recursos Vencidos');
  ...
  listar(pagina = 0) {
    ...
    this.atendimentoLaiService.listaRecursosVencidoLai(this.filtro)
      .then(resultado =>{
