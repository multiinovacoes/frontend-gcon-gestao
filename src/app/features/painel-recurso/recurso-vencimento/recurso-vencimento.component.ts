...
@Component({
  selector: 'app-recurso-vencimento',
  templateUrl: './recurso-vencimento.component.html',
  styleUrls: ['./recurso-vencimento.component.css']
})
export class RecursoVencimentoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.title.setTitle('Lista de Recursos Próximos ao Vencimento');
  ...
  listar(pagina = 0) {
    ...
    this.atendimentoLaiService.listaRecursosVencimentoLai(this.filtro)
      .then(resultado =>{
